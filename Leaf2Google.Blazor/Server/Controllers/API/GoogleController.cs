...
public class GoogleController : BaseController
{
    ...
    public async Task<JsonResult> Token([FromForm] IFormCollection form)
    {
        ...
        var jwtToken = JWTHelper.CreateJWT(StorageManager.VehicleSessions[token.Owner.Owner.CarModelId], Configuration, token.Owner, DateTime.UnixEpoch.AddMinutes(1));
